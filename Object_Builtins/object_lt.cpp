...
static Object Builtin_Int32_Int32_lt(const Object& oleft, const Object& oright)
{
    Object oresult;
...
operator3 Object::lt_function(ObjectType left, ObjectType right)
{
    if (left == ObjectType::Int32 && right == ObjectType::Int32)
        return Builtin_Int32_Int32_lt;
    return nullptr;
}
