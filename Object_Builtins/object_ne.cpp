...
static Object Builtin_Int32_Int32_ne(const Object& oleft, const Object& oright)
{
    Object oresult;
...
static Object Builtin_Bool_Bool_ne(const Object& oleft, const Object& oright)
{
    Object oresult;
    oresult.SetType(ObjectType::Bool);
...
operator3 Object::ne_function(ObjectType left, ObjectType right)
{
    if (left == ObjectType::Int32 && right == ObjectType::Int32)
        return Builtin_Int32_Int32_ne;
    if (left == ObjectType::Bool  && right == ObjectType::Bool)
        return Builtin_Bool_Bool_ne;
    return nullptr;
}
